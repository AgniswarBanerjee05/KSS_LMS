...
if 'postgresql://kss_data_user:FvzK33oNuhFt9WQHuE8zXGEmFesI36nv@dpg-cta6g556l47c73biq8r0-a.oregon-postgres.render.com/kss_data' in os.environ:
    # Production environment (Render or any other hosting platform)
    DATABASES = {
